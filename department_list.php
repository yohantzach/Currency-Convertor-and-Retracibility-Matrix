	...
	<div class="card card-outline card-primary">
		<div class="card-header">
			<div class="card-tools">
				<button class="btn btn-sm btn-primary btn-block" type='button' id="new_department"><i class="fa fa-plus"></i> New Plan</button>
			</div>
		</div>
		<div class="card-body">
...
<script>
	...
	$('#new_department').click(function(){
		uni_modal("New Plan","manage_department.php")
	})
	$('.edit_department').click(function(){
		uni_modal("Edit Plan","manage_department.php?id="+$(this).attr('data-id'))
	})
	$('.delete_department').click(function(){
	_conf("Are you sure to delete this plan?","delete_department",[$(this).attr('data-id')])
	})
