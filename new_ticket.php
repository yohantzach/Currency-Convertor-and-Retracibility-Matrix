		...
		<div class="card-body">
			<form action="" id="manage_ticket">
				<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
					...
					<?php endif; ?>
						<div class="form-group">
							<label for="" class="control-label">Savings</label>
					...
					<div class="col-md-12">
						<div class="form-group">
							<label class="control-label">Initial Lump sum and Monthly amount or Currency Needed to buy </label>
				...
				<div class="col-lg-12 text-right justify-content-center d-flex">
					<button class="btn btn-primary mr-2">Make Investment</button>
					<button class="btn btn-secondary" type="reset">Clear</button>
					<a href="index.html" class="btn btn-info ml-2">Currency Converter </a>
					<a href="currency.html" class="btn btn-info ml-2">Savings and Investments</a>
				</div>
			</form>
		</div>
	</div>
